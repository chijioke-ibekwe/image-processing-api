...
var changeImageSize = function (filename, width, height) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, sharp_1.default)(path_1.default.join(__dirname, '..', '..', '..', 'images', 'full', "".concat(filename, ".jpg")))
                    .resize(width, height)
                    .toFile(path_1.default.join(__dirname, '..', '..', '..', 'images', 'thumbnails', "".concat(filename, "-").concat(width, "-").concat(height, ".jpg")))];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                else if (!fs_1.default.existsSync(inputImagePath)) {
                    errorMessage = 'file not found';
                }
                if (!(errorMessage != null)) return [3 /*break*/, 1];
                res
                    .status(400)
            ...
            case 1:
                ...
                return [3 /*break*/, 4];
            case 2: return [4 /*yield*/, changeImageSize(filename, width, height)];
            case 3:
                _a.sent();
                res.status(200).sendFile(outputImagePath);
                _a.label = 4;
